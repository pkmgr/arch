...
# @Resource    : https://github.com/arcolinuxd/arco-xmonad
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
##################################################################################################################
__printf_head "Installing the xmonad desktop"
##################################################################################################################

__install_pkg xmonad
__install_pkg xmonad-utils
__install_pkg xmonad-contrib
__install_pkg arcolinux-xmobar-git
__install_pkg arcolinux-xfce-git
__install_pkg arcolinux-xmonad-polybar-git
__install_pkg haskell-dbus

##################################################################################################################
__printf_head "Configuring desktop packages"
##################################################################################################################
...
[ ! -d "$HOME/.xmonad" ] && [ -d "/etc/skel/.xmonad" ] &&
  __run_post "cp -rT /etc/skel/.xmonad $HOME/.xmonad"

[ ! -d "$HOME/.xmobar" ] && [ -d "/etc/skel/.xmobar" ] &&
  __run_post "cp -rT /etc/skel/.xmobar $HOME/.xmobar"

__run_post "dotfiles install xmonad"
