...
##################################################################################################################
printf_head "Installing the xmonad desktop"
##################################################################################################################

install_pkg xmonad
install_pkg xmonad-utils
install_pkg xmonad-contrib
install_pkg arcolinux-xmobar-git
install_pkg arcolinux-xfce-git
install_pkg arcolinux-xmonad-polybar-git
install_pkg haskell-dbus

##################################################################################################################
printf_head "Configuring desktop packages"
##################################################################################################################
...
[ ! -d "$HOME/.xmonad" ] && [ -d "/etc/skel/.xmonad" ] &&
  run_post "cp -rT /etc/skel/.xmonad $HOME/.xmonad"

[ ! -d "$HOME/.xmobar" ] && [ -d "/etc/skel/.xmobar" ] &&
  run_post "cp -rT /etc/skel/.xmobar $HOME/.xmobar"

run_post "dotfiles install xmonad"
