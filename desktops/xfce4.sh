...
##################################################################################################################
printf_head "Installing the xfce4 desktop"
##################################################################################################################
...
install_pkg arcolinux-config-xfce-git
install_pkg arcolinux-xfce-dconf-git
...
[ ! -d "$HOME/.config/xfce4" ] && [ -d "/etc/skel/.config/xfce4" ] &&
  run_post "cp -rT /etc/skel/.config/xfce4 $HOME/.config/xfce4"
