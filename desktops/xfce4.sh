...
# @Resource    : https://github.com/arcolinuxd/arco-xfce4
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
##################################################################################################################
__printf_head "Installing the xfce4 desktop"
##################################################################################################################

__install_pkg xfce4
__install_pkg xfce4-goodies

__install_pkg arcolinux-local-xfce4-git
__install_pkg arcolinux-xfce-git
__install_pkg arcolinux-config-xfce-git
__install_pkg arcolinux-xfce-dconf-git
...
[ ! -d "$HOME/.config/xfce4" ] && [ -d "/etc/skel/.config/xfce4" ] &&
  __run_post "cp -rT /etc/skel/.config/xfce4 $HOME/.config/xfce4"
