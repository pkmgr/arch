...
# @Resource    : https://github.com/arcolinuxd/arco-openbox
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__install_pkg openbox

__install_pkg arcolinux-xfce-git
__install_pkg arcolinux-openbox-git
__install_pkg arcolinux-config-openbox-git
__install_pkg arcolinux-openbox-dconf-git
...
[ ! -d "$HOME/.config/openbox" ] && [ -d "/etc/skel/.config/openbox" ] &&
  __run_post "cp -rT /etc/skel/.config/openbox $HOME/.config/openbox"

__run_post "dotfiles install openbox"
