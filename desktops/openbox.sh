...
install_pkg arcolinux-openbox-git
install_pkg arcolinux-config-openbox-git
install_pkg arcolinux-openbox-dconf-git
...
[ ! -d "$HOME/.config/openbox" ] && [ -d "/etc/skel/.config/openbox" ] &&
  run_post "cp -rT /etc/skel/.config/openbox $HOME/.config/openbox"

run_post "dotfiles install openbox"
