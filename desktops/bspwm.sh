...
install_pkg arcolinux-bspwm-git
install_pkg arcolinux-config-bspwm-git
install_pkg arcolinux-bspwm-dconf-git
...
[ ! -d "$HOME/.config/bspwm" ] && [ -d "/etc/skel/.config/bspwm" ] &&
  run_post "cp -rT /etc/skel/.config/bspwm $HOME/.config/bspwm"

run_post "dotfiles install bspwm"
