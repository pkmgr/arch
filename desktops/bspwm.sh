...
# @Resource    : https://github.com/arcolinuxd/arco-bspwm
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__install_pkg arcolinux-bspwm-git
__install_pkg arcolinux-config-bspwm-git
__install_pkg arcolinux-bspwm-dconf-git
...
[ ! -d "$HOME/.config/bspwm" ] && [ -d "/etc/skel/.config/bspwm" ] &&
  __run_post "cp -rT /etc/skel/.config/bspwm $HOME/.config/bspwm"

__run_post "dotfiles install bspwm"
