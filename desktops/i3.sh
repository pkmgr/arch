...
# @Resource    : https://github.com/arcolinuxd/arco-i3
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__install_pkg i3-wm
__install_pkg i3status
__install_pkg i3-gaps

__install_pkg arcolinux-xfce-git
__install_pkg arcolinux-i3wm-git
__install_pkg arcolinux-config-i3wm-git
__install_pkg arcolinux-i3wm-dconf-git
...
[ ! -d "$HOME/.config/i3" ] && [ -d "/etc/skel/.config/i3" ] &&
  __run_post "cp -rT /etc/skel/.config/i3 $HOME/.config/i3"

__run_post "dotfiles install i3"
