...
install_pkg arcolinux-i3wm-git
install_pkg arcolinux-config-i3wm-git
install_pkg arcolinux-i3wm-dconf-git
...
[ ! -d "$HOME/.config/i3" ] && [ -d "/etc/skel/.config/i3" ] &&
  run_post "cp -rT /etc/skel/.config/i3 $HOME/.config/i3"

run_post "dotfiles install i3"
